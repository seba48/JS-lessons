(function($) {
    $(function() {
        ...
        $('ul.tabs__caption').on('click', 'li:not(.active)', function() {
            ...
            function winner()
            {
                if(($("#1").attr('text')=$("#2").attr('text')=$("#3").attr('text')) ||
                   $(("#4").attr('text')=$("#5").attr('text')=$("#6").attr('text')) ||
                   $(("#7").attr('text')=$("#8").attr('text')=$("#9").attr('text')) ||
                   $(("#1").attr('text')=$("#4").attr('text')=$("#7").attr('text')) ||
                   $(("#2").attr('text')=$("#5").attr('text')=$("#8").attr('text')) ||
                   $(("#3").attr('text')=$("#6").attr('text')=$("#9").attr('text')) ||
                   $(("#1").attr('text')=$("#5").attr('text')=$("#9").attr('text')) ||
                   $(("#7").attr('text')=$("#5").attr('text')=$("#7").attr('text')) 
                   ) 
                    {
                        alert('ok');
                    }
            };
            function labelxo(sel,mark)
            {
               sel.text(mark);
            }
